      ...
      <main className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <section className="py-20 md:py-28 flex flex-col items-start justify-center max-w-3xl">
          ...
          <p className="mt-6 text-lg md:text-xl text-[#94A3B8] leading-relaxed">
            We design, architect, and deploy resilient, deterministic, and secure AI infrastructure. We do not build generic wrappers; we build mission-critical enterprise systems designed for high-performance, high-reliability operations.
          </p>
